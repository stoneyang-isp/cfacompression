function [im_result, delta_est, phi_est] = process_images_for_script(im, reconstruction, factor, crop_factor, separation_filter, cfa_type, need_post_processing, gamma);
% PROCESS_IMAGES_FOR_SCRIPT - process images using joint super-resolution and demosaicing
% [im_result, delta_est, phi_est] = process_images_for_script(im, reconstruction, factor, crop_factor, separation_filter, cfa_type, need_post_processing, gamma);
